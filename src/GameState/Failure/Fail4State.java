...
public class Fail4State extends GameState {

	private double textappear;
	private int currentChoice;
	
	private String[] story = {
			"When you type in the password, an alarm blares out.",
			"You hide the phone, but McMaster’s followers find you.",
			"",
			...
			"",
			"Hints:",
			"Find the derivative of the function and set equal to -1",
			"Tangent lines are lines that have the same point\n"
			+ "and slope",
			"",
	...
	public Fail4State(GameStateManager gsm) {
		this.gsm = gsm;
		lineNum = 0;
		init();
	}
