...
public class Fail3State extends GameState {

	private double textappear;
	private int currentChoice;
	
	private String[] story = {
			"You jump, but you are a bit (far/short) from the green.",
			"You close your eyes and brace for the fall…",
			"",
			...
			"Height is describing position, speed is velocity",
			"You hit the ground when height is 0",
	...
	public Fail3State(GameStateManager gsm) {
		this.gsm = gsm;
		lineNum = 0;
		init();
	}
