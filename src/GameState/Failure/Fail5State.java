...
public class Fail5State extends GameState {

	private double textappear;
	private int currentChoice;
	
	private String[] story = {
			"On your way to the destination, you run into some\n"
			+ "of McMaster’s followers.",
			"",
			"They recognize you and capture you.",
			"If only you didn’t go this way…",
			"",
	...
	public Fail5State(GameStateManager gsm) {
		this.gsm = gsm;
		lineNum = 0;
		init();
	}
