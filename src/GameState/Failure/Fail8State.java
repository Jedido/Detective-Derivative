...
public class Fail8State extends GameState {

	private double textappear;
	private int currentChoice;
	
	private String[] story = {
			"You enter a circular loop where you wander for hours and\n"
			+ "eventually exit realizing that you went through\n"
			+ "the wrong hallway.",
			"",
			"",
			"",
			...
			"(cos \u2192 -sin) , (-sin \u2192 -cos) and not (-sin \u2192 cos)",
			};
	...
	public Fail8State(GameStateManager gsm) {
		this.gsm = gsm;
		lineNum = 0;
		init();
	}
