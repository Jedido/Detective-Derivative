...
public class Fail6State extends GameState {

	private double textappear;
	private int currentChoice;
	
	private String[] story = {
			"You answer but she frowns.",
			"\"You are not Master McMaster’s fans.\n"
			+ "Boys, get him!\"",
			"",
			"She shouts, and some burly calculus men come out.",
			...
			"",
			"Hints:",
			"The constant is untouched in the product rule",
	...
	public Fail6State(GameStateManager gsm) {
		this.gsm = gsm;
		lineNum = 0;
		init();
	}
